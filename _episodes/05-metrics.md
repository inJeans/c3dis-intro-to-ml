...
|:------------|:--------------------------|:-----------------------|
| error       | <img src="../fig/097d7b763604d69d7509ac7adece4096.svg?invert_in_darkmode&sanitize=true" align=middle width=87.82486679999998pt height=24.65753399999998pt/>             | 1 - `metrics.accuracy_score` |
